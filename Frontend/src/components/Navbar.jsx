...
import { Bell, BellOff, UserCircle, Menu, X, BarChart3, Target, Wifi, WifiOff, Loader2, User, LogOut, Activity, Settings, RefreshCw } from "lucide-react";
...
export default function Navbar({ onLogout, lastUpdate, overallHealth, isRefreshing, onRefresh }) {
                  ...
                  <div className="absolute right-0 mt-2 w-72 bg-white border border-slate-200 rounded-lg shadow-lg z-50">
                    <div className="p-4">
                      <div className="flex items-center justify-between mb-3">
                        <h3 className="text-sm font-semibold text-slate-700">Notification Settings</h3>
                        <button
                      ...
                      <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg mb-3">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <p className="text-sm font-medium text-slate-700">Alert Popups</p>
                            <p className="text-xs text-slate-500">Auto-prediction alerts</p>
                          </div>
                        </div>
                        <button
                        ...
                        {notificationsEnabled ? (
                          <div className="flex items-start gap-2">
                            ...
                            <div>
                              ...
                              <p className="mt-1 text-green-600">You'll receive alerts when machine health is critical</p>
                            </div>
                          </div>
                        ) : (
                          <div className="flex items-start gap-2">
                            ...
                            <div>
                              ...
                              <p className="mt-1 text-red-600">Auto-prediction alert popups are hidden</p>
                            </div>
                          </div>
                        )}
                      </div>
